  ...
  return (
    <div className="pt-20 pb-20">
      ...
      <div className="flex flex-col sm:flex-row gap-12 sm:gap-3 justify-center text-center pt-10">
        <div className="P-container flex flex-col mx-auto sm:mx-0 ">
          ...
          >
            <Image
              ...
              width={500}
              height={500}
              className="bg-cover h-80 w-96 object-cover mx-auto transform transition-all hover:scale-110"
            />
          </Link>
        ...
        <div className="P-container flex flex-col mx-auto sm:mx-0 ">
          <Link href="https://our-holiday-planner.netlify.app/" target="_blank">
            <Image
        ...
        <div className="P-container flex flex-col mx-auto sm:mx-0 ">
          <Link href="https://our-recipe-planner.netlify.app/" target="_blank">
            <Image
