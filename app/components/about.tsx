  ...
  return (
    <div className="w-2/3 flex mx-auto gap-12 pt-20 pb-20">
      ...
      <div>
        ...
        <p className="text-lg pb-1">
          Recently, I have embarked on a journey into the realm of testing with
          Jest, a popular testing framework for JavaScript applications. I aim
          to ensure the resilience and reliability of the codebases I work on,
          delivering robust solutions that meet the highest standards of
          quality.
        </p>
        <p className="text-lg pb-1">
